...
3. Выберите состав установки:
   - `GUI и CLI` - графический интерфейс и консольная утилита.
   - `Только GUI` - только графический интерфейс.
...
- `GUI и CLI` - установить графическое приложение и консольную утилиту.
- `Только GUI` - установить только `trino-excel-client-gui.exe`.
